...
public class Node {
    ...
    public Node(int x, int y, boolean is_walkable, int movement_cost, String node_type) {
    ...
    public void setGvalue(Node parent_node) {
        ...
        this.g_value = (parent_node.getGvalue() + this.movement_cost);
    }

    public int calcGValue(Node parent_node) {

        return (parent_node.getGvalue() + this.movement_cost);
    }
